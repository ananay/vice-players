...
void InitGame(RakNet::BitStream *bitStream, Packet *packet)
{
	...
	bitStream->Read((float)pNetGame->m_vecInitPlayerPos.X);
	bitStream->Read((float)pNetGame->m_vecInitPlayerPos.Y);
	bitStream->Read((float)pNetGame->m_vecInitPlayerPos.Z);
	bitStream->Read((float)pNetGame->m_vecInitCameraPos.X);
	bitStream->Read((float)pNetGame->m_vecInitCameraPos.Y);
	bitStream->Read((float)pNetGame->m_vecInitCameraPos.Z);
	bitStream->Read((float)pNetGame->m_vecInitCameraLook.X);
	bitStream->Read((float)pNetGame->m_vecInitCameraLook.Y);
	bitStream->Read((float)pNetGame->m_vecInitCameraLook.Z);
	bitStream->Read((float)pNetGame->m_WorldBounds[0]);
	bitStream->Read((float)pNetGame->m_WorldBounds[1]);
	bitStream->Read((float)pNetGame->m_WorldBounds[2]);
	bitStream->Read((float)pNetGame->m_WorldBounds[3]);
...
void RequestClass(RakNet::BitStream *bitStream, Packet *packet)
{
	...
	bitStream->Read((float)SpawnInfo.vecPos.X);
	bitStream->Read((float)SpawnInfo.vecPos.Y);
	bitStream->Read((float)SpawnInfo.vecPos.Z);
	bitStream->Read((float)SpawnInfo.fRotation);
